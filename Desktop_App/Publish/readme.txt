...
2) When the URLs of any agencies change, please refer to "AgencyInfo.csv" file
...
3) When the configuration of the geodatabase changes, please modify the "data-source.xml" accordingly:
